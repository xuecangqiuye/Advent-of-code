...
public class Day14 {
    ...
    public static void main(String[] args) {
        ...
        for (String s : split) {
            ...
            matcher.find();
            int px = Integer.parseInt(matcher.group());
            matcher.find();
            int py = Integer.parseInt(matcher.group());
            matcher.find();
